...
static t_file_matching file_matches[] = {
  ...
  { DEV_RUST, MATCH( F("Cargo.toml") ), LIGHT_MAROON},
  { DEV_RUST, MATCH( S(".rs") ), MAROON},
  ...
  { FA_FILE_CODE, MATCH( S(".xml") ), BLUE},
  { DEV_WEBPACK, MATCH( P("webpack.") ), BLUE},
  ...
  { DEV_SCALA, MATCH( S(".sc", ".scala") ), RED},
  { DEV_PYTHON, MATCH( S(".tac") ), DARK_PINK},
  { DEV_PYTHON, MATCH( S(".pyw") ), MAROON},
  { DEV_PYTHON, MATCH( S(".pyi") ), BLUE},
  { DEV_PYTHON, MATCH( S(".py3") ), DARK_BLUE},
  { DEV_PYTHON, MATCH( S(".pyt") ), DARK_GREEN},
  { DEV_PYTHON, MATCH( S(".pip") ), DARK_PURPLE},
  { DEV_PYTHON, MATCH( S(".gypi") ), DARK_GREEN},
  { DEV_PYTHON, MATCH( S(".gyp") ), GREEN},
  { DEV_PYTHON, MATCH( S(".pep") ), ORANGE},
  { DEV_PYTHON, MATCH( S(".isolate") ), DARK_GREEN},
  { DEV_PYTHON, MATCH( S(".ipy") ), BLUE},
  { DEV_PYTHON, MATCH( S(".py") ), DARK_BLUE},
  { FILE_PHP, MATCH( P("Phakefile") ), DARK_GREEN},
  { FILE_PHP, MATCH( S(".php") ), DARK_BLUE},
  { DEV_PERL, MATCH( S(".psgi", ".xs") ), RED},
  { DEV_PERL, MATCH( S(".pm") ), DARK_BLUE},
  { DEV_PERL, MATCH( S(".plx") ), PURPLE},
  { DEV_PERL, MATCH( S(".ph", "pl") ), DARK_PURPLE},
  { DEV_PERL, MATCH( S(".perl", "pl") ), BLUE},
  { FILE_ORG, MATCH( S(".org") ), DARK_GREEN},
  { DEV_NODEJS, MATCH( S(".node", ".node-version") ), DARK_GREEN},
  { DEV_NODEJS, MATCH( S(".njs", ".nvmrc") ), GREEN},
  ...
  { DEV_MARKDOWN, MATCH( S(".md", ".markdown") ), BLUE},
  { OCT_BOOK, MATCH( F("LICENSE", "license") ), YELLOW},
  { FILE_JULIA, MATCH( S(".jl") ), PURPLE},
  { DEV_REACT, MATCH( S(".jsx", ".react", ".react.js") ), BLUE},
  { DEV_JAVA, MATCH( S(".java") ), PURPLE},
  { FA_DASHBOARD, MATCH( S(".cpuprofile") ), GREEN},
  { FA_DASHBOARD, MATCH( S(".slim", ".skim") ), ORANGE},
  { DEV_RUBY, MATCH( S(".watcher") ), DARK_YELLOW},
  { DEV_RUBY, MATCH( F("rails") ), RED},
  { DEV_RUBY, MATCH( S(".rbuild", ".rbw", ".rbx") ), DARK_RED},
  { DEV_RUBY, MATCH( F(".irbrc", ".gemrc", ".pryrc", ".ruby-gemset", ".ruby-version") ), RED},
  { DEV_RUBY, MATCH( F("irbrc", "gemrc", "pryrc", "ruby-gemset", "ruby-version") ), RED},
  { DEV_RUBY, MATCH( S(".pluginspec", ".podspec", ".rabl", ".rake", ".opal") ), RED},
  { DEV_RUBY, MATCH( S(".ruby", ".rb", ".ru", ".erb", ".gemspec", ".god", ".mspec") ), RED},
  ...
  { DEV_GULP, MATCH( F("gulpfile.coffee") ), MAROON},
  { DEV_GULP, MATCH( F("gulpfile.js", "gulpfile.babel.js") ), RED},
  { DEV_GRUNT, MATCH( F("gruntfile.coffee") ), MAROON},
  { DEV_GRUNT, MATCH( F("gruntfile.js") ), YELLOW},
  ...
  { FA_DOCKER, MATCH( F("docker-sync") ), DARK_ORANGE},
  { FA_DOCKER, MATCH( F("Dockerfile", "docker-compose"), S(".dockerfile", ".dockerignore") ), DARK_BLUE},
  ...
  { DEV_SASS, MATCH( S(".scss", ".sass") ), PINK},
  ...
  { FA_FILE_TEXT, MATCH( S(".mk"),
				F("Makefile", "MAKEFILE", "makefile")), PINK},
  { DEV_GIT, MATCH( P(".git"),
  ...
  { FA_FILE_TEXT, MATCH( S(".log", ".journal") ), MAROON},
  { FA_FILE_TEXT, MATCH( S(".srt") ), PURPLE},
  ...
  { DEV_WINDOWS, MATCH( S(".exe", ".com", ".msi", ".bat",
			 ".cmd", ".reg") ), DARK_PURPLE},
  ...
  { DEV_HTML5, MATCH( S(".html") ), ORANGE},
  { DEV_HTML5, MATCH( S(".html.erb") ), RED},
  ...
  { DEV_JAVASCRIPT, MATCH( S(".js", ".node", "._js", ".es6", ".es") ), YELLOW},
  ...
  { FA_GEAR, MATCH( S(".conf"), S(".config"), S(".ini"), S(".desktop"),
  ...
  { FILE_EXCEL, MATCH( S(".xlsx")), GREEN},
  { OCT_BOOKMARK, MATCH( F("bookmark") ), LIGHT_PINK},
  { FA_FILE_TEXT, MATCH( S(".txt", ".text") ), BLUE},
...
int print_arrow_right(FILE *stream) {
  const char arrow[] = " "FA_ARROW_RIGHT" ";
